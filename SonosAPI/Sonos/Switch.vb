...
Public Class Switch
   ...
   Public Function ToLineIn(ip As IPAddress, device As Device) As String
   ...
   Public Function ToLineIn(device As Device) As String
   ...
   Public Function ToTVIn(ip As IPAddress, device As Device) As String
      Dim uri = $"http://{ip}:1400/MediaRenderer/AVTransport/Control"
      Dim soapAction = "urn:schemas-upnp-org:service:AVTransport:1#SetAVTransportURI"
      Dim soapMessage = <s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/" s:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
                           <s:Body>
   ...
   Public Function ToQueueIn(ip As IPAddress, device As Device) As String
      Dim uri = $"http://{ip}:1400/MediaRenderer/AVTransport/Control"
      Dim soapAction = "urn:schemas-upnp-org:service:AVTransport:1#SetAVTransportURI"
      Dim soapMessage = <s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/" s:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
                           <s:Body>
